...
interface QuickGuideProps extends WizardComponentProps {}
...
export const QuickGuide: React.FC<QuickGuideProps> = (props: QuickGuideProps) => {
  return <>
    <RegistrationBackground>
      ...
      <RegistrationStatement title={'Discover DApps'} description={'Power Hub gives people around the world a safe and trusted place to discover dapps that\n' +
        'are secured by blockchain with high standards of privacy and security'}/>
      <RegistrationStatement title={'Build & Publish'} description={'Build Dapp where everything is in one place:  decentralized infrastructure\n' +
