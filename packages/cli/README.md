...
running command...
$ tp (--version)
@thepowereco/cli/1.0.7 darwin-x64 node-v14.18.1
$ tp --help [COMMAND]
USAGE
  $ tp COMMAND
...
...
_See code: [dist/src/commands/upload/index.ts](https://github.com/thepower/power_hub/blob/v1.0.7/dist/src/commands/upload/index.ts)_
<!-- commandsstop -->
