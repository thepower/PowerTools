...
running command...
$ tpe (--version)
@thepowereco/cli/1.11.125 linux-x64 node-v21.6.2
$ tpe --help [COMMAND]
USAGE
  $ tpe COMMAND
...
...
_See code: [src/commands/acc/get-balance.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/acc/get-balance.ts)_
...
_See code: [src/commands/acc/register.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/acc/register.ts)_
...
_See code: [src/commands/acc/send-sk.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/acc/send-sk.ts)_
...
_See code: [src/commands/contract/deploy.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/contract/deploy.ts)_
...
_See code: [src/commands/contract/get.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/contract/get.ts)_
...
EXAMPLES
  $ tpe contract set --abiPath ./path/to/abi.json --address AA100000001677748249 --chain 1 --keyFilePath ./path/to/keyfile.pem --method set --params value1 value2 --password mypassword

  $ tpe contract set -a ./path/to/abi.json -d AA100000001677748249 -c 1 -k ./path/to/keyfile.pem -m set -r value1 value2 -p mypassword

  $ tpe contract set --abiPath ./path/to/abi.json --address AA100000001677748249 --chain 1 --keyFilePath ./path/to/keyfile.pem --method setData --params param1 param2
```

_See code: [src/commands/contract/set.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/contract/set.ts)_
...
_See code: [src/commands/storage/tasklist.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/storage/tasklist.ts)_
...
_See code: [src/commands/storage/upload.ts](https://github.com/thepower/PowerTools/blob/v1.11.125/src/commands/storage/upload.ts)_
